...
class InputExample(object):
  ...
  Args:
      ...
      intent_label: (Optional) int. The intent label of the example.
      slot_labels: (Optional) list. The slot labels of the example.
  """

  def __init__(self, guid, words: list, intent_label: Optional[int] = None, slot_labels: Optional[list] = None):
    self.guid = guid
    self.words = words
...
def load_and_cache_examples(args, tokenizer, mode):
  ...
  if os.path.exists(cached_features_file) and not args.overwrite_cache:
    ...
    if not cache_matches_tokenizer(features, tokenizer):
      logger.warning("Ignoring incompatible cached features in %s",
